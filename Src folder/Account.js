...
export default class Account extends React.Component {
  ...
  updateTheData = () => {
    let temp = this.state.seletedDropDown,
    ...
    localStorage.setItem(
      "AccountsData",
      JSON.stringify(this.state.updatedData)
    );
  ...
  dropDownClick = (e) => {
    let a = e.target.options.selectedIndex,
      newData,
      temp;
    if (a == 1) {
          ...
          <div>
            ...
            <div>
              <div className="Input--wrapper">
                ...
                <br />
                <select
                  onChange={(e) => this.dropDownClick(e)}
            ...
            <div>
              <div className="Input--wrapper">
                ...
                <div
                  className="btn"
                  id="UploadNewPhoto"
                  onClick={() => this.uploadNewPhoto("UploadNewPhoto")}
                >
                  UPLOAD NEW PHOTO
                </div>
                <input
          ...
          <div className="rightContainer">
            ...
            <form ref={this.form}>
              ...
              <div className="containers--wrapper">
                ...
                <div className="Input--wrapper--container">
                  <div className="Input--wrapper">
                    <label for="AccountRe-Password">Re-enter Password</label>
                    <br />
              ...
              <div className="containers--wrapper">
                ...
                <div className="Input--wrapper--container">
                  <div className="Input--wrapper">
                    <label for="Accounts" style={{ visibility: "hidden" }}>
                      UPDATE Your Profile{" "}
                    </label>
                    <br />
                    <div className="btn" onClick={this.updateTheData}>
                      UPDATE YOUR PROFILE
                    </div>
                    {}
                  </div>
