...
export default class Dashboard extends React.Component {
  ...
  msgHighlite = (msg) => {
    let temp = msg.split(" "),
      temp2 = "Jessica Oliver Too Victoria 6 others",
      temp3 = " product updates. order";
    return (
      <>
        {temp.map((item) => {
          if (temp2.includes(item)) {
            return <b> {item} </b>;
          } else if (temp3.includes(item)) {
            return (
              <a href="#" className="updateLink">
                {" "}
                {item}
              </a>
            );
  ...
  render() {
    ...
    let lineChartDataset = this.lineChart(
      this.state.data.dasbhoardPage.latestHits
    );
      ...
      <div className="page-container">
        ...
        <div className="containers--wrapper">
          <div className="table--container Input--wrapper--container">
            <label className="containers--subtitle">Latest Hits</label>
            <br />
            <div className="charts">
              <Line
                ...
                options={{
                  indexAxis: "x",
                  plugins: {
                    legend: { labels: { font: { size: 10 }, color: "#fff" } },
                  },
          ...
          <div className="table--container Input--wrapper--container">
            <label className="containers--subtitle">Performance</label>
            <br />
            <div className="charts">
              <Bar
                data={{
        ...
        <div className="containers--wrapper">
          <div className="table--container Input--wrapper--container">
            <label className="containers--subtitle">Storage Information</label>
            <br />
          ...
          <div className="table--container Input--wrapper--container">
            <label className="containers--subtitle">Notification List</label>
            <br />
            <div className="table">
                        ...
                        <tr className="notification--tr">
                          <td className="notifications-container">
                            ...
                            <div className="notification-content">
                              <div className="notigication-msg">
                                <p>{this.msgHighlite(item.message)}</p>
                              </div>
                              <div className="notigication-time">
                                {item.time}
                              </div>
                            </div>
                          </td>
        ...
        <div className="table--container">
          <label className="container--title">Orders List</label>
          <br />
